...
powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -Command ^ Compress-Archive -Force -Path "%PROJECT_ROOT%\out\WindowsNoEditor\*" -DestinationPath "%PROJECT_ROOT%\GamsPlugins_Win64_v%VERSION%.zip"
